...
const canonicalIcon="https://raw.githubusercontent.com/ThiaJay/stremio-story-order/main/public/logo.png?v=1.0.33";
...
assert.match(html,/branding\/v5\/story-order-hero-approved\.webp\?v=1\.0\.33/);
...
assert.match(html,/branding\/v5\/example-story-path\.svg\?v=1\.0\.33/);
