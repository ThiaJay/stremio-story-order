...
const canonicalIcon="https://raw.githubusercontent.com/ThiaJay/stremio-story-order/main/public/logo.png?v=1.0.29";
...
assert.match(html,/branding\/v4\/hero-01\.webp\?v=1\.0\.29/);
assert.match(html,/branding\/v4\/hero-05\.webp\?v=1\.0\.29/);
assert.match(html,/class="hero-tiles"/);
assert.match(html,/class="hero-tile"/);
...
assert.match(html,/aspect-ratio:1000\/375/);
assert.match(html,/hero-art-ready/);
assert.match(html,/Promise\.all\(imgs\.map\(waitFor\)\)/);
